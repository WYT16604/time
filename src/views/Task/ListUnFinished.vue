<template>
  <div class="ListUnFinished">
    <!--
         卡片模式：显示三条的清单记录 
      -->
    <div class="ListUnFinished_content">
      <div class="ListUnFinished_left">
        <el-calendar @click="getDate()" v-model="date" />
      </div>
      <div class="ListUnFinished_right">
        <h4>{{ time }}</h4>
        <ul>
